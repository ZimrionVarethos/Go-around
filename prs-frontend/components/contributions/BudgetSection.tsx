      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        ...
        <div className="space-y-1.5">
          ...
          <div className="relative">
            ...
            <input
              ...
              placeholder="18.000"
              className="w-full h-11 pl-9 pr-3 text-xs bg-white border border-gray-200 rounded-xl text-gray-900 focus:outline-none focus:ring-1 focus:ring-[#005B54]"
            />
          </div>
        ...
        <div className="space-y-1.5">
          ...
          <select
            ...
            className="w-full h-11 px-3 text-xs bg-white border border-gray-200 rounded-xl text-gray-900 focus:outline-none focus:ring-1 focus:ring-[#005B54] cursor-pointer"
          >
